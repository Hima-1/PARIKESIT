...
abstract class IDokumentasiRepository {
  ...
  Future<DokumentasiKegiatan> getActivityById(String id);
  Future<DokumentasiKegiatan> createActivity(Map<String, dynamic> data);
...
class DokumentasiRepositoryImpl extends BaseRepository
    implements IDokumentasiRepository {
...
final dokumentasiRepositoryProvider = Provider<IDokumentasiRepository>((ref) {
  final client = ref.watch(dioProvider);
  return DokumentasiRepositoryImpl(client);
});
