...
<div id="navbar"
    ...
    <div class="flex flex-row-reverse items-center">
        ...
        <div class="dropdown relative md:static tge">
            ...
            <button class="menu-btn focus:outline-none focus:shadow-outline flex flex-wrap items-center" dusk="user-menu-toggle">
            ...
            <div
                ...
                <form method="POST" action="{{ route('logout') }}" class="inline-block w-full">
                    @csrf
                    <button type="submit" class="px-4 py-2 block capitalize font-medium text-sm tracking-wide bg-white hover:bg-gray-200 hover:text-gray-900 transition-all duration-300 ease-in-out text-black w-100" dusk="user-menu-logout">
